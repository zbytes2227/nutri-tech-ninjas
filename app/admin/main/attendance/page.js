...
import getAttendance from "@/pages/api/getAttendance";
...
const Page = () => {
  ...
  function fetchSearch() {
    setAttendance([])
    fetch(`/api/getCard?search=${searchQuery}`)
  ...
  function report() {
    exportToCSV(processedAttendance);
  }
      ...
      <div class="p-4 sm:ml-64">
        <div class=" mt-14">
          ...
          <div className="flex justify-between my-3 px-5 items-center" >
            <p className="text-xl font-bold">All Attendances</p>
